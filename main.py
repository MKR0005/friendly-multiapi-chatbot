...
def main():
    ...
    # Initialize the Reasoning class (assuming you need to create an instance)
    reasoning = Reasoning(api_key=Config.API_CONFIG["reasoning_api_key"]["headers"]["Authorization"])
